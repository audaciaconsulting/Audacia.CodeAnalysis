...
This applies to `Xunit`, `FluentAssertions`, and `Shouldly` assertions, as well as mock verification assertions using `Moq` (`Verify*`) and `NSubstitute` (`Received*`, `DidNotReceive*`, `InOrder`).
