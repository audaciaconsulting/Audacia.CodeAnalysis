...
namespace Audacia.CodeAnalysis.Analyzers.Shared.Extensions
{
    ...
    public static class SyntaxExtensions
    {
        ...
        public static bool IsArgumentNullCheck(this StatementSyntax statementSyntax)
        {
        ...
        public static bool IsArgumentNullCheck(this IfStatementSyntax ifStatementSyntax)
        {
        ...
        /// </summary>
        /// <param name="ifStatementSyntax"></param>
        public static bool IsSingleStatement(this IfStatementSyntax ifStatementSyntax)
        {
        ...
        /// </summary>
        /// <param name="ifStatementSyntax"></param>
        public static bool ContainsThrowArgumentNullExceptionStatement(this IfStatementSyntax ifStatementSyntax)
        {
        ...
        public static bool IsThrowArgumentNullExceptionStatement(this ThrowStatementSyntax throwStatementSyntax)
        {
        ...
        public static StatementSyntax EmbeddedStatement(this CommonForEachStatementSyntax forEachStatement)
        {
        ...
        public static StatementSyntax EmbeddedStatement(this DoStatementSyntax doStatement)
        {
        ...
        public static StatementSyntax EmbeddedStatement(this FixedStatementSyntax fixedStatement)
        {
        ...
        public static StatementSyntax EmbeddedStatement(this ForStatementSyntax forStatement)
        {
        ...
        public static StatementSyntax EmbeddedStatement(this IfStatementSyntax ifStatement)
        {
        ...
        public static StatementSyntax EmbeddedStatement(this LockStatementSyntax lockStatement)
        {
        ...
        public static StatementSyntax EmbeddedStatement(this WhileStatementSyntax whileStatement)
        {
        ...
        public static StatementSyntax EmbeddedStatement(this UsingStatementSyntax usingStatement, bool allowUsingStatement = true)
        {
        ...
        public static StatementSyntax EmbeddedStatement(this ElseClauseSyntax elseClause, bool allowIfStatement = true)
        {
