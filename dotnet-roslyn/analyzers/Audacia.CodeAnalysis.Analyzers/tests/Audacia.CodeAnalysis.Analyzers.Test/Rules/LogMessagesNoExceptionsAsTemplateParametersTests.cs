...
class ClassName
{
    ...
    private void Method()
    {
        ...
        logger.LogInformation(args: [new System.Exception(), 123 ], message: ""Error: {Error}"");
    }
}";
            var expectedOne = BuildExpectedResult(15, 51, "new System.Exception()");
            var expectedTwo = BuildExpectedResult(16, 38, "new System.Exception()");
            VerifyDiagnostic(test, expectedOne, expectedTwo);
        }
    }
}
